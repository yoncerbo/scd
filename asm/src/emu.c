  ...
  for (uint32_t i = 0; i < cycles; ++i) {
    ...
    switch (op) {
      ...
      case OP_SRL:
        ...
        break;
      case OP_SRA:
        e->regs[r0] = Emu_update_flags(e, (int16_t)e->regs[r1] >> 1);
        break;
      case OP_JLR:
        e->regs[r0] = e->pc;
        e->pc = Emu_update_flags(e, e->regs[r1] + e->regs[r2]);
        break;
      case OP_JLI:
        e->regs[r0] = e->pc;
        e->pc = imm;
      ...
      case OP_B__:
        ...
        break;
      case OP_ADI:
        e->regs[r0] = Emu_update_flags(e, e->regs[r1] + simm);
        break;
      case OP_STB:
        e->memory[e->regs[r1]] = e->regs[r2];
        break;
      case OP_LDB:
        e->regs[r0] = e->memory[r1];
        break;
      case OP_LDI:
        e->regs[r0] = imm;
        break;
